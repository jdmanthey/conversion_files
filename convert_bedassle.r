convert_bedassle <- function(structure, popmap) {
	library(BEDASSLE)
	...
	snp.names <- as.vector(as.character(snp.names))
	...
	write.table(allele.matrix, file="bedassle.allele.counts.txt", sep="\t",
		quote=FALSE, row.names=FALSE, col.names=FALSE)	
	write.table(sample.size.matrix, file="bedassle.sample.sizes.txt", sep="\t",
		quote=FALSE, row.names=FALSE, col.names=FALSE)		
